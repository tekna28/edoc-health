                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                    <div class="row">
                      ...
                      <div>
                      <center><h1><span style="color: #53BDA5; display: inline-block; white-space: nowrap;"><b><font size="+3"><u>Add a Doctor:</u></font></b></span></h1></center><br>
                      </div>
                      ...
                      <form action="{{url('upload_doctor')}}" method="POST">
                        ...
                        <div style="padding: 15px;">
                            <label><b>Doctor's Surname:</b></label><br>
                            <input type="text" name="surname" size=50 placeholder="Doctor's Surname" required=""><br>
                        </div>

                        <div style="padding: 15px;">
                            <label><b>Doctor's First Name:</b></label><br>
                            <input type="text" name="name" size=50 placeholder="Doctor's First Name" required=""><br>
                        </div>

                        <div style="padding: 15px;">
                            <label><b>Description:</b></label><br>
                            <textarea name="description" rows="4" cols="50" placeholder="Description" required=""></textarea><br>
                        </div>

                        <div style="padding: 15px;">
                            <label><b>Phone Number:</b></label><br>
                            <input type="tel" name="number" size=50 placeholder="Phone Number" required=""><br>
                        </div>

                        <div style="padding: 15px;">
                            
                          <b><input type="submit" value="Submit" style="height: 50px; width: 100px" class="btn btn-success"><b><br>
                        </div>
                      </form>
                      </div>
