                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                    <div class="row">
                      ...
                      <div>
                      <h1><span style="color: #53BDA5; display: inline-block; white-space: nowrap;"><b><font size="+3"><u>Add a Patient:</u></font></b></span></h1><br>
                      </div>
                      ...
                      <form action="{{url('upload_patient')}}" method="POST">
                        @csrf
                        <div style="padding: 15px;">
                            <label><b>Patient's Surname:</b></label><br>
                            <input type="text" name="surname" size=50 placeholder="Patient's Surname" required=""><br>
                        </div>

                        <div style="padding: 15px;">
                            <label><b>Patient's First Name:</b></label><br>
                            <input type="text" name="name" size=50 placeholder="Patient's First Name" required=""><br>
                        </div>

                        <div style="padding: 15px;">
                            <label><b>Patient's Email:</b></label><br>
                            <input type="email" name="email" size=50 placeholder="Patient's Email" required=""><br>
                        </div>

                        <div style="padding: 15px;">
                            <label><b>Date of Birth:</b></label><br>
                            <input type="date" name="date_birth"  style="width: 200px;" required=""><br>
                        </div>
            ...
            <select name="doctor" id="departement" class="custom-select">
              ...
              <option value="Mansouri Amine Médecin géneraliste">Mansouri Amine General practitioner</option>
                        ...
                        <div style="padding: 15px;">
                            ...
                            <input type="tel" name="phone" size="50" placeholder="Phone Number" required=""><br>
                        </div>

                        <div style="padding: 15px;">
                            
                          <input type="submit" value="Submit" style="height: 50px; width: 100px" class="btn btn-success"><br>
                        </div>
                      </form>
                      </div>
