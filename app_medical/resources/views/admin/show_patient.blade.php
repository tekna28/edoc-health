                      ...
                      <div align="center" style="padding-top: 0px;">
                            <table>
                                <tr style="background-color: #53BDA5;">
                                    <th style="padding: 10px; font-size: 20px">Patient's Surname</th>
                                    <th style="padding: 10px; font-size: 20px">Patient's First Name</th>
                                    <th style="padding: 10px; font-size: 20px">Email</th>
                                    <th style="padding: 10px; font-size: 20px">Date of Birth</th>
                                    <th style="padding: 10px; font-size: 20px">Doctor</th>
                                    <th style="padding: 10px; font-size: 20px">Phone Number</th>
                                ...
                                <tr align="center" style="background-color: white;">
                                    <td style="padding: 10px; font-size: 15px">{{$patient->surname}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$patient->name}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$patient->email}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$patient->date_birth}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$patient->doctor}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$patient->phone}}</td>
                                    <td>
                                        <a class="btn btn-primary" style="height:50px; width: 120px" href="{{url('updatepatient', $patient->id)}}"><b><font size="+1">Edit</font></b></a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger" style="height:50px; width: 120px" onclick="return confirm('Êtes-vous sûr de vouloir supprimer le patient ?')" href="{{url('deletepatient', $patient->id)}}"><b><font size="+1">Delete</font></b></a>
                                    </td>
                                </tr>
