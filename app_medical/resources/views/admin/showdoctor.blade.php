                      ...
                      <div align="center" style="padding-top: 0px;">
                            <table>
                                <tr style="background-color: #53BDA5;">
                                    <th style="padding: 10px; font-size: 20px">Doctor's Surname</th>
                                    <th style="padding: 10px; font-size: 20px">Doctor's Name</th>
                                    <th style="padding: 10px; font-size: 20px">Description/Specialty</th>
                                ...
                                <tr align="center" style="background-color: white;">
                                    <td style="padding: 10px; font-size: 15px">{{$doctor->surname}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$doctor->name}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$doctor->description}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$doctor->phone}}</td>
                                    <td>
                                        <a class="btn btn-primary" style="height:50px; width: 120px" href="{{url('updatedoctor')}}"><b><font size="+1">Edit</font></b></a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger" style="height:50px; width: 120px" onclick="return confirm('Êtes-vous sûr de vouloir supprimer le médecin ?')" href="{{url('deletedoctor', $doctor->id)}}"><b><font size="+1">Delete</font></b></a>
                                    </td>
