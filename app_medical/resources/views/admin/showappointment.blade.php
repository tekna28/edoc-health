                        ...
                        <div align="center" style="padding-top: 0px;">
                            <table>
                                <tr style="background-color: #53BDA5;">
                                    ...
                                    <th style="padding: 10px; font-size: 20px">Approve</th>
                                    <th style="padding: 10px; font-size: 20px">Cancel</th>
                                </tr>

                                @foreach($data as $appoint)

                                <tr align="center" style="background-color: white;">
                                    <td style="padding: 10px; font-size: 15px">{{$appoint->surname}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$appoint->name}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$appoint->date_birth}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$appoint->date_rdv}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$appoint->doctor}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$appoint->message}}</td>
                                    <td style="padding: 10px; font-size: 15px">{{$appoint->status}}</td>
                                    <td>
                                        <a class="btn btn-success" style="height:50px; width: 100px" href="{{url('approved', $appoint->id)}}"><b><font size="+1">Approve</font></b></a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger" style="height:50px; width: 100px" href="{{url('canceled', $appoint->id)}}"><b><font size="+1">Cancel</font></b></a>
                                    </td>
                                </tr>
